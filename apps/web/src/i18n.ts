...
const dict = {
  ru: {
    ...
    backupHint: "Без этого файла потерянный телефон = потерянный аккаунт. Пароль на сервер не уходит.",
    backupPassphrase: "Пароль резервной копии",
    downloadBackup: "Скачать резервную копию",
    backupSaved: "Файл сохранён. Храните его отдельно от телефона.",
    restoreHint: "Тот же ключ вернёт тот же аккаунт. История подтянется из файла.",
  ...
  en: {
    ...
    backupHint: "Without this file a lost phone is a lost account. The passphrase never goes to the server.",
    backupPassphrase: "Backup passphrase",
    downloadBackup: "Download backup",
    backupSaved: "File saved. Keep it off this phone.",
    restoreHint: "The same key returns the same account. History comes from the file.",
