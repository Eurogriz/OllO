...
export function bytesToB64(bytes: Uint8Array): string {
  const Buf = (globalThis as unknown as { Buffer?: { from(d: Uint8Array): { toString(e: string): string } } }).Buffer;
...
export function b64ToBytes(b64: string): Uint8Array {
  const Buf = (globalThis as unknown as { Buffer?: { from(d: string, e: string): Uint8Array } }).Buffer;
